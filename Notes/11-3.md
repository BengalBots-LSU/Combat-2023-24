...
## Accomplished
 - Worked on assembling the parts with the Arduino Nano Every so we can test if the trasmitter is sending the right values and the receiver is receiving the values correctly. 
